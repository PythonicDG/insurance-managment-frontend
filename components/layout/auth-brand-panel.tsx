...
export function AuthBrandPanel() {
  ...
  return (
    <div className="w-full lg:w-[48%] xl:w-[45%] h-full bg-[#f3f7fd] px-6 py-6 sm:px-10 sm:py-8 lg:px-12 lg:py-10 xl:px-16 flex flex-col border-r border-slate-200/50 overflow-hidden">
      {/* Brand Logo */}
