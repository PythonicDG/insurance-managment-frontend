        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">
              Customers &amp; Phone Directory
            </h1>
            <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
              Lookup customers by normalized phone number, handle shared family numbers, and update profiles.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              disabled={refreshing}
              className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 shadow-2xs transition-colors cursor-pointer"
            >
